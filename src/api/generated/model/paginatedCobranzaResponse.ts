 ...
 */
import type { CuentaPorCobrar } from "./cuentaPorCobrar";
import type { PaginatedCobranzaResponseMeta } from "./paginatedCobranzaResponseMeta";

export interface PaginatedCobranzaResponse {
  data: CuentaPorCobrar[];
  meta: PaginatedCobranzaResponseMeta;
}
