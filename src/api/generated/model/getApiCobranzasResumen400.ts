 ...
 */
import type { GetApiCobranzasResumen400ErrorsItem } from "./getApiCobranzasResumen400ErrorsItem";

export type GetApiCobranzasResumen400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiCobranzasResumen400ErrorsItem[];
};
