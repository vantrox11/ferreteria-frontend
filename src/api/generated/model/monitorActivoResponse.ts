 ...
 */
import type { MonitorActivoResponseDataItem } from "./monitorActivoResponseDataItem";

export interface MonitorActivoResponse {
  /** Lista de cajas abiertas con KPIs */
  data: MonitorActivoResponseDataItem[];
}
