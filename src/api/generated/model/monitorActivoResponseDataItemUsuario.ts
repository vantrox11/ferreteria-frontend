 ...
 */
import type { MonitorActivoResponseDataItemUsuarioNombre } from "./monitorActivoResponseDataItemUsuarioNombre";

/**
 * Información del cajero
 */
export type MonitorActivoResponseDataItemUsuario = {
  id: number;
  nombre: MonitorActivoResponseDataItemUsuarioNombre;
  email: string;
};
