 ...
 */
import type { GetApiCuentasPorCobrarIdPagos400ErrorsItem } from "./getApiCuentasPorCobrarIdPagos400ErrorsItem";

export type GetApiCuentasPorCobrarIdPagos400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiCuentasPorCobrarIdPagos400ErrorsItem[];
};
