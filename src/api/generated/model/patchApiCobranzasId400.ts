 ...
 */
import type { PatchApiCobranzasId400ErrorsItem } from "./patchApiCobranzasId400ErrorsItem";

export type PatchApiCobranzasId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PatchApiCobranzasId400ErrorsItem[];
};
