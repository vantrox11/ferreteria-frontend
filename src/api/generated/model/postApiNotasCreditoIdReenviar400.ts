 ...
 */
import type { PostApiNotasCreditoIdReenviar400ErrorsItem } from "./postApiNotasCreditoIdReenviar400ErrorsItem";

export type PostApiNotasCreditoIdReenviar400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiNotasCreditoIdReenviar400ErrorsItem[];
};
