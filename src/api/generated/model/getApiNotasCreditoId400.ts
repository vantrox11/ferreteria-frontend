 ...
 */
import type { GetApiNotasCreditoId400ErrorsItem } from "./getApiNotasCreditoId400ErrorsItem";

export type GetApiNotasCreditoId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiNotasCreditoId400ErrorsItem[];
};
