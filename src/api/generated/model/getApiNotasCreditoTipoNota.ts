...
export type GetApiNotasCreditoTipoNota =
  (typeof GetApiNotasCreditoTipoNota)[keyof typeof GetApiNotasCreditoTipoNota];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetApiNotasCreditoTipoNota = {
