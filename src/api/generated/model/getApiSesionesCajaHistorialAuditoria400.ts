 ...
 */
import type { GetApiSesionesCajaHistorialAuditoria400ErrorsItem } from "./getApiSesionesCajaHistorialAuditoria400ErrorsItem";

export type GetApiSesionesCajaHistorialAuditoria400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiSesionesCajaHistorialAuditoria400ErrorsItem[];
};
