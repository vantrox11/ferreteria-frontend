 ...
 */
import type { GetApiSesionesCajaMonitorActivo400ErrorsItem } from "./getApiSesionesCajaMonitorActivo400ErrorsItem";

export type GetApiSesionesCajaMonitorActivo400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiSesionesCajaMonitorActivo400ErrorsItem[];
};
