 ...
 */
import type { PaginatedPagosDataItem } from "./paginatedPagosDataItem";
import type { PaginatedPagosMeta } from "./paginatedPagosMeta";

export interface PaginatedPagos {
  data: PaginatedPagosDataItem[];
  meta: PaginatedPagosMeta;
}
