 ...
 */
import type { GetApiGuiasRemision400ErrorsItem } from "./getApiGuiasRemision400ErrorsItem";

export type GetApiGuiasRemision400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiGuiasRemision400ErrorsItem[];
};
