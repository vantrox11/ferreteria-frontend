 ...
 */
import type { GuiaRemisionDetalleProductoSku } from "./guiaRemisionDetalleProductoSku";

/**
 * Datos del producto
 */
export type GuiaRemisionDetalleProducto = {
  id: number;
  nombre: string;
  sku: GuiaRemisionDetalleProductoSku;
};
