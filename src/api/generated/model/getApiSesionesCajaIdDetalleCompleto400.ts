 ...
 */
import type { GetApiSesionesCajaIdDetalleCompleto400ErrorsItem } from "./getApiSesionesCajaIdDetalleCompleto400ErrorsItem";

export type GetApiSesionesCajaIdDetalleCompleto400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiSesionesCajaIdDetalleCompleto400ErrorsItem[];
};
