 ...
 */
import type { CuentaPorCobrarPagosItemUsuarioAnyOfNombre } from "./cuentaPorCobrarPagosItemUsuarioAnyOfNombre";

/**
 * Datos del usuario que registró el pago
 */
export type CuentaPorCobrarPagosItemUsuarioAnyOf = {
  id: number;
  nombre: CuentaPorCobrarPagosItemUsuarioAnyOfNombre;
  email: string;
};
