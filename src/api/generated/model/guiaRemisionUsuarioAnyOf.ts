 ...
 */
import type { GuiaRemisionUsuarioAnyOfNombre } from "./guiaRemisionUsuarioAnyOfNombre";

/**
 * Datos del usuario emisor
 */
export type GuiaRemisionUsuarioAnyOf = {
  id: number;
  nombre: GuiaRemisionUsuarioAnyOfNombre;
  email: string;
};
