 ...
 */
import type { GetApiNotasCredito400ErrorsItem } from "./getApiNotasCredito400ErrorsItem";

export type GetApiNotasCredito400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiNotasCredito400ErrorsItem[];
};
