 ...
 */
import type { GetApiDashboardVentas400ErrorsItem } from "./getApiDashboardVentas400ErrorsItem";

export type GetApiDashboardVentas400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiDashboardVentas400ErrorsItem[];
};
