 ...
 */
import type { PostApiCobranzasIdPagos400ErrorsItem } from "./postApiCobranzasIdPagos400ErrorsItem";

export type PostApiCobranzasIdPagos400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiCobranzasIdPagos400ErrorsItem[];
};
