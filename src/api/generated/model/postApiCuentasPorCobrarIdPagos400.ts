 ...
 */
import type { PostApiCuentasPorCobrarIdPagos400ErrorsItem } from "./postApiCuentasPorCobrarIdPagos400ErrorsItem";

export type PostApiCuentasPorCobrarIdPagos400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiCuentasPorCobrarIdPagos400ErrorsItem[];
};
