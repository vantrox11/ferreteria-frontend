 ...
 */
import type { PagoCuentaPorCobrarEstado } from "./pagoCuentaPorCobrarEstado";
import type { PagoCuentaPorCobrarVenta } from "./pagoCuentaPorCobrarVenta";

/**
 * Datos de la cuenta por cobrar asociada (solo en listados paginados)
 */
export type PagoCuentaPorCobrar = {
  id: number;
  monto_total: number;
  saldo_pendiente: number;
  estado: PagoCuentaPorCobrarEstado;
  venta?: PagoCuentaPorCobrarVenta;
};
