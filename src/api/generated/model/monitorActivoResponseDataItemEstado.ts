 ...
 * Estado de la sesión
 */
export type MonitorActivoResponseDataItemEstado =
  (typeof MonitorActivoResponseDataItemEstado)[keyof typeof MonitorActivoResponseDataItemEstado];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MonitorActivoResponseDataItemEstado = {
  ABIERTA: "ABIERTA",
} as const;
