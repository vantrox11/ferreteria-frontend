 ...
 */
import type { GuiaRemision } from "./guiaRemision";
import type { PaginatedGuiaRemisionResponseMeta } from "./paginatedGuiaRemisionResponseMeta";

export interface PaginatedGuiaRemisionResponse {
  data: GuiaRemision[];
  meta: PaginatedGuiaRemisionResponseMeta;
}
