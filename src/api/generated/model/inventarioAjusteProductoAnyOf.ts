 ...
 */
import type { InventarioAjusteProductoAnyOfSku } from "./inventarioAjusteProductoAnyOfSku";

/**
 * Información del producto ajustado
 */
export type InventarioAjusteProductoAnyOf = {
  id: number;
  nombre: string;
  sku: InventarioAjusteProductoAnyOfSku;
  stock_actual: number;
};
