 ...
 */
import type { GetApiGuiasRemisionId400ErrorsItem } from "./getApiGuiasRemisionId400ErrorsItem";

export type GetApiGuiasRemisionId400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiGuiasRemisionId400ErrorsItem[];
};
