 ...
 */
import type { PostApiNotasCredito400ErrorsItem } from "./postApiNotasCredito400ErrorsItem";

export type PostApiNotasCredito400 = {
  message: string;
  /** Lista de campos con errores */
  errors: PostApiNotasCredito400ErrorsItem[];
};
