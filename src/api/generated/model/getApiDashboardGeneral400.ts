 ...
 */
import type { GetApiDashboardGeneral400ErrorsItem } from "./getApiDashboardGeneral400ErrorsItem";

export type GetApiDashboardGeneral400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiDashboardGeneral400ErrorsItem[];
};
