 ...
 */
import type { HistorialAuditoriaResponseDataItemUsuarioNombre } from "./historialAuditoriaResponseDataItemUsuarioNombre";

export type HistorialAuditoriaResponseDataItemUsuario = {
  id: number;
  nombre: HistorialAuditoriaResponseDataItemUsuarioNombre;
  email: string;
};
