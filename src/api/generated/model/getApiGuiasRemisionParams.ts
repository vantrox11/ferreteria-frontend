 ...
 */
import type { GetApiGuiasRemisionEstadoSunat } from "./getApiGuiasRemisionEstadoSunat";
import type { GetApiGuiasRemisionMotivo } from "./getApiGuiasRemisionMotivo";

export type GetApiGuiasRemisionParams = {
  /**
   * Número de página
   */
  page?: number;
   ...
   */
  estado_sunat?: GetApiGuiasRemisionEstadoSunat;
  /**
   * Filtrar por motivo de traslado
   */
  motivo?: GetApiGuiasRemisionMotivo;
  /**
