 ...
 */
import type { GetApiVentasIdSaldoNc400ErrorsItem } from "./getApiVentasIdSaldoNc400ErrorsItem";

export type GetApiVentasIdSaldoNc400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiVentasIdSaldoNc400ErrorsItem[];
};
