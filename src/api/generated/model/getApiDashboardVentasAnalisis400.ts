 ...
 */
import type { GetApiDashboardVentasAnalisis400ErrorsItem } from "./getApiDashboardVentasAnalisis400ErrorsItem";

export type GetApiDashboardVentasAnalisis400 = {
  message: string;
  /** Lista de campos con errores */
  errors: GetApiDashboardVentasAnalisis400ErrorsItem[];
};
