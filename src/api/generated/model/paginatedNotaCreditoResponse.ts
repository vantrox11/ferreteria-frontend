 ...
 */
import type { NotaCredito } from "./notaCredito";
import type { PaginatedNotaCreditoResponseMeta } from "./paginatedNotaCreditoResponseMeta";

export interface PaginatedNotaCreditoResponse {
  data: NotaCredito[];
  meta: PaginatedNotaCreditoResponseMeta;
}
