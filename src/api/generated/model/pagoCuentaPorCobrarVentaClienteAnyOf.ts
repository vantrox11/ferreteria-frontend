 ...
 */
import type { PagoCuentaPorCobrarVentaClienteAnyOfRazonSocial } from "./pagoCuentaPorCobrarVentaClienteAnyOfRazonSocial";

export type PagoCuentaPorCobrarVentaClienteAnyOf = {
  nombre: string;
  razon_social: PagoCuentaPorCobrarVentaClienteAnyOfRazonSocial;
};
