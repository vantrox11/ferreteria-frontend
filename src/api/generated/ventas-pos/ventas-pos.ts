...
import type {
  ...
  GetApiVentasId409,
  GetApiVentasId500,
  GetApiVentasIdSaldoNc400,
  GetApiVentasIdSaldoNc401,
  GetApiVentasIdSaldoNc403,
  GetApiVentasIdSaldoNc404,
  GetApiVentasIdSaldoNc409,
  GetApiVentasIdSaldoNc500,
  GetApiVentasParams,
...
/**
 * Calcula el saldo disponible para emitir Notas de Crédito sobre una venta.
 ...
 */
export const getApiVentasIdSaldoNc = (
  id: number,
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
  return customInstance<SaldoNCResponse>(
    { url: `/api/ventas/${id}/saldo-nc`, method: "GET", signal },
    options,
  );
};

export const getGetApiVentasIdSaldoNcQueryKey = (id?: number) => {
  return [`/api/ventas/${id}/saldo-nc`] as const;
};

export const getGetApiVentasIdSaldoNcQueryOptions = <
  TData = Awaited<ReturnType<typeof getApiVentasIdSaldoNc>>,
  TError = ErrorType<
    | GetApiVentasIdSaldoNc400
    | GetApiVentasIdSaldoNc401
    | GetApiVentasIdSaldoNc403
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getApiVentasIdSaldoNc>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetApiVentasIdSaldoNcQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getApiVentasIdSaldoNc>>
  > = ({ signal }) => getApiVentasIdSaldoNc(id, requestOptions, signal);
...
export type GetApiVentasIdSaldoNcQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiVentasIdSaldoNc>>
>;
export type GetApiVentasIdSaldoNcQueryError = ErrorType<
  | GetApiVentasIdSaldoNc400
  | GetApiVentasIdSaldoNc401
  | GetApiVentasIdSaldoNc403
  | GetApiVentasIdSaldoNc404
...
export function useGetApiVentasIdSaldoNc<
  TData = Awaited<ReturnType<typeof getApiVentasIdSaldoNc>>,
  TError = ErrorType<
    | GetApiVentasIdSaldoNc400
    | GetApiVentasIdSaldoNc401
...
>(
  ...
  const queryOptions = getGetApiVentasIdSaldoNcQueryOptions(id, options);
